      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            >
              {active ? t('builder.editing') : t('builder.editTexts')}
            </button>
            {active && (
              <div
                aria-hidden="true"
  ...
  return (
    <div className="relative">
      ...
      {editing && editingSection && fields.length > 0 && (
        <aside className="fixed top-0 right-0 z-9998 flex h-svh w-full max-w-md flex-col border-l border-ink/20 bg-bone text-ink shadow-xl">
      ...
      {editing && fields.length === 0 && (
        <aside className="fixed top-4 right-4 z-9998 max-w-xs border border-ink/20 bg-bone p-4 text-sm text-ink/70 shadow-xl">
