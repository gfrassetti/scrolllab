          ...
          <div data-hero-tilt className="absolute inset-0" style={{ transformStyle: 'preserve-3d' }}>
            ...
            >
              <span
                data-hero-tab
                aria-hidden="true"
                className="absolute top-1/2 left-0 z-10 h-24 w-7 -translate-x-[70%] -translate-y-1/2 overflow-hidden rounded-l-2xl bg-[#1a1424]"
              >
                <img src={img} alt="" className="h-full w-[400%] max-w-none object-cover object-left" />
              </span>
              <div data-hero-shot className="h-full w-full overflow-hidden">
                <img src={img} alt="" className="h-full w-full object-cover object-[center_20%]" />
              </div>
            </article>
          </div>
        </div>
