...
export default function FooterLedger({
  ...
  row4Label = 'Prev. 02',
  row4Value = 'TITLE TWO',
  spine1Title = 'Title one',
  spine1Author = 'Name one',
  spine2Title = 'Title two',
  spine2Author = 'Name two',
  spine3Title = 'Title three',
  spine3Author = 'Name three',
  spine4Title = 'Title four',
  spine4Author = 'Name four',
  spine5Title = 'Title five',
  spine5Author = 'Name five',
  anchor = 'index',
}) {
