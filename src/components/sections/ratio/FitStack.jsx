...
export default function FitStack({
  noteLabel = '(Notes)',
  note1 = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
  note2 = 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
  note2Mark = '',
  note3 = 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.',
  note3Mark = '',
  phrase = 'HEADLINE',
  breakLine = 'TITLE TWO',
  rulesLine = 'TITLE THREE',
  worthLine = '(TITLE FOUR)',
  closer = '(A PLACEHOLDER LINE)',
  brand = 'RATIO',
