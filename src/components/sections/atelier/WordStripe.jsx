...
/**
 * WordStripe — same pinned shutter transition as VisionShutter
 * (bars expand + words scrub), placed before the footer.
 */
export default function WordStripe({
  ...
  useGSAP(
    () => {
      ...
      const wordsEl = root.current.querySelector('[data-shutter-words]')
