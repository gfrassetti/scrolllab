...
const allModels = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'atrium/ClarityPair', name: 'Clarity Pair', kind: 'section', component: ClarityPair, blurb: 'Paper-to-ink hinge: a radial diagram draws itself, then the field inverts' },
      ...
      { id: 'atrium/ProjectRail', name: 'Project Rail', kind: 'section', component: ProjectRail, blurb: 'Work index with bands of photos at their own scale and parallax' },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'signal/SelectedWorkIndex', name: 'Selected Work Index', kind: 'section', component: SelectedWorkIndex, blurb: 'Work list with a cursor-trailing preview image that swaps per row' },
    ...
    sections: [
      {
        ...
        blurb:
          'Catalog on the page; PDP, cart and a full checkout (shipping, discount code, thumbnail summary) as separate screens',
      },
    ],
  },
]
